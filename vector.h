 ...
 * @retval VECTOR_UNITIALIZED_ERROR when input vector pointer or input vector are NULL 
 * @retval VECTOR_ALLOCATION_ERROR when reallocation to increase capacity fails 
 * @retval VECTOR_OVERFLOW when vector is full and capacity cannot be increased 
 ...
 * @retval VECTOR_SUCCESS on success 
 * @retval VECTOR_UNITIALIZED_ERROR when input vector pointer or input vector are NULL 
 * @retval VECTOR_ALLOCATION_ERROR when reallocation to decrease capacity fails 
 * @retval VECTOR_UNDERFLOW when vector is empty
 * (cover all possibilities) 
 ...
 * @retval VECTOR_SUCCESS on success 
 * @retval VECTOR_UNITIALIZED_ERROR when input vector pointer or input vector are NULL 
 * @retval VECTOR_INDEX_OUT_OF_BOUNDS_ERROR when input index is out of the vector array range
